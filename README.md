...
Check [example.ty](./examples/example.typ) to get started. The following screenshot shows how it looks.
...
2. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/psiace/unlink.git
   cd unlink
   ```
...
4. **Edit your CV**:
   ...
   Open the `examples/example.typ` file in your preferred text editor to customize the layout.
...
- Continued from [Vantage Typst](https://github.com/sardorml/vantage-typst), to match my personal preferences.
